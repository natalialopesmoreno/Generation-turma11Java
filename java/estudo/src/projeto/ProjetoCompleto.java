...
public class ProjetoCompleto 
{
		public static void main(String[] args) 
		{
			...
			int opcPgto = 0;// opÃ§Ã£o de pagamento
			int desconto = 0; // Desconto do pagamento a vista
			int valorComDesconto = 0; // valor final caso pagamento a vista
			int parcelaCartao = 0; // opÃ§Ã£o de parcelamento caso escolha pagar no cartÃ£o
			...
			System.out.println("â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•� BEM VIDES A ABACADABRA FANTASIAS â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�\n");
			System.out.print("Por favor, digite seu nome: ");
			nome = leia.next();
			System.out.println("GÃªnero: [F] - Feminino\n\t[M] - Masculino\n\t[O] - Outros");
			System.out.print("Por favor, digite seu gÃªnero: ");
						...
						while (contador == 'S') {
							...
							case 2: {
								...
								if (totalItensCarrinho > 0) {
									...
									System.out.println("NÃ£o hÃ¡ itens ainda no seu carrinho para serem removidos!\n");
								}
								break;
							}
			...
			System.out.println(
					"â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•� PRODUTOS MEU CARRINHO â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�\n");
			...
			System.out.print(
					"[1] Ã€ vista com 10% de desconto \n[2] No cartÃ£o de crÃ©dito em atÃ© 3x sem juros \nOpÃ§Ã£o Escolhida: ");
			...
			if (opcPgto == 1) {
				...
				if (parcelaCartao == 1) {
					...
					System.out.println("1Âª Parcela de " + valorParcelado + " para " + formatador.format(parcela1));
					System.out.println("2Âª Parcela de " + valorParcelado + " para " + formatador.format(parcela2));
					...
					System.out.println("1Âª Parcela de " + valorParcelado + " para " + formatador.format(parcela1));
					System.out.println("2Âª Parcela de " + valorParcelado + " para " + formatador.format(parcela2));
					System.out.println("3Âª Parcela de " + valorParcelado + " para " + formatador.format(parcela3));
				}
			}

			System.out.println(
					"â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•� NOTA FISCAL â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�");
			System.out.println(
					"IdentificaÃ§Ã£o do emitente: Lojas Abrakadabra - Rua. Conego\n Eugenio Leite, 623. 3Âº andar. Pinheiros â€“ SÃ£o Paulo â€“ SP  ");
			System.out.println(
					"consulta de autenticidade no portal nacional da NF-e.\n www.nfe.fazenda.gov.br/portal ou no site da Sefaz Autorizada ");
			System.out.println("NF-e: 000.000.394 ");
			System.out.println("Nome/RazÃ£o social: " + nome);
			System.out.println("Sexo: " + sexo);

			System.out.println("\n CÃ�LCULO DO IMPOSTO");

			System.out.println(
					"Base de cÃ¡lculo do ICMS: " + subtotal + " valor do ICMS: " + subtotal * 0.09 + " \nValor do frete: 0");
			System.out.println("\n DESCRIÃ‡ÃƒO DOS PRODUTOS: ");		
			System.out.println(
					"â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•� PRODUTOS LOJAS ABRACADABRA â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�\n");
			System.out.print("CÃ“D â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•� QTDE â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•� PRODUTO â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•�â•� PREÃ‡O\n");
